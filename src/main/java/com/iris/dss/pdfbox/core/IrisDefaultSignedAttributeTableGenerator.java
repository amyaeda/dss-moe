 ...
 */
public class IrisDefaultSignedAttributeTableGenerator implements CMSAttributeTableGenerator {
    private final Hashtable table;

    /**
     * Initialise to use all defaults
     */
    public IrisDefaultSignedAttributeTableGenerator()
    {
        table = new Hashtable();
    }
    ...
    protected Hashtable createStandardAttributeTable(Map parameters)
    {
        ...
        {            		
            //Date signingTime = IrisPDFBox.calendar.getTime();              
        	Date signingTime = (Date)parameters.get(IrisPDFBox.SIGNING_TIME);
        	System.out.println(">>> " + this.getClass().getSimpleName() + ">signingTime: "+ signingTime );    

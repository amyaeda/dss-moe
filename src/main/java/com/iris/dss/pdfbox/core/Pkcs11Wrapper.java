 ...
 *
 *  @version $Id: Pkcs11Wrapper.java 19902 2014-09-30 14:32:24Z anatom $
 *
 */
public class Pkcs11Wrapper {
    ...
    private Pkcs11Wrapper(final String fileName) throws Exception {
     ...
     */
    public static Pkcs11Wrapper getInstance(final File file) throws Exception {
        final String canonicalFileName;
        try {
            canonicalFileName = file.getCanonicalPath();
        } catch (IOException e) {
            throw new Exception(file+" is not a valid filename.",e );
        }
        {
    ...
    private long[] C_GetSlotList() throws Exception {
        try {
    ...
    private char[] getTokenLabelLocal(long slotID) throws Exception  {

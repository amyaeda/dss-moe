...
public class IrisCMSSignedGenerator
{
    /**
     ...
     * base constructor
     */
    protected IrisCMSSignedGenerator()
    {
    }
    ...
    public void addCertificates(
        ...
        throws CMSException
    {
        certs.addAll(IrisCMSUtils.getCertificatesFromStore(certStore));
    }
    ...
    public void addCRLs(
        ...
        throws CMSException
    {
        crls.addAll(IrisCMSUtils.getCRLsFromStore(crlStore));
    }
    ...
    public void addAttributeCertificates(
        ...
        throws CMSException
    {
        certs.addAll(IrisCMSUtils.getAttributeCertificatesFromStore(attrStore));
    }
    ...
    {
        crls.addAll(IrisCMSUtils.getOthersFromStore(otherRevocationInfoFormat, otherRevocationInfos));
    }
     ...
     */
    public void addSignerInfoGenerator(IrisSignerInfoGenerator infoGen)
    {

...
public class ReplaceString
{
    ...
    // String inputFile, String outputFile, String strToFind, String message)
    public void doIt(String strToFind, String message) throws Exception {
        ...
        try
        {
            doc = PDDocument.load( new File("C:/Users/trlok/Desktop/PDF_Template_Test.pdf") );
                ...
                for( int j=0; j < tokens.size(); j++ )
                {
                    ...
                    if( next instanceof Operator )
                    {
                        ...
                        if( op.getName().equals( "Tj" ) )
                        {
                            ...
                            //previous.reset();
                            previous.setValue(string.getBytes("ISO-8859-1") );
                        }
            ...
            doc.save(new File("C:/Users/trlok/Desktop/PDF_Template_Test.replaced.pdf"));
            //newDoc.close();

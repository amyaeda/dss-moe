...
class IrisCMSSignedHelper
{
    static final IrisCMSSignedHelper INSTANCE = new IrisCMSSignedHelper();
    ...
    static
    {
        ...
        encryptionAlgs.put(IrisCMSSignedDataGenerator.ENCRYPTION_RSA_PSS, "RSAandMGF1");
